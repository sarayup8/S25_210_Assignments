...
// rotating left
// make an object --> AVL Tree newRoot = this.getRight()
// make another object --> AVL Tree newLeft = new AVLTree()
// newLeft._value = this.value
// newLeft._left = this._left
// newRoot._left = newleft

// danglingNode = newRoot.getLeft()
// newLeft._right = danglingNode